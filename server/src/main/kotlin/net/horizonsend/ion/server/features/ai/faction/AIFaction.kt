	...
	companion object {
		...
		val SYSTEM_DEFENSE_FORCES = builder("SYSTEM_DEFENSE_FORCES", PRIVATEER_LIGHT_TEAL.value())
			...
			.addNames(
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Trainee Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Private Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Cadet Quincy".miniMessage(),
			...
			.addNames(
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Pilot Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Corporal Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ensign Quincy".miniMessage(),
			)
			.addNames(
				2,
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Veteran Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Sergeant Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Lieutenant Quincy".miniMessage(),
			)
			.addNames(
				3,
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Ace Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Major Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Commander Quincy".miniMessage(),
			)
			.addNames(
				4,
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Elite Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Colonel Quincy".miniMessage(),
				...
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Maya".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Warner".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Risa".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Rukh".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Dila".miniMessage(),
				"<$PRIVATEER_MEDIUM_TEAL>SysDef <$PRIVATEER_LIGHT_TEAL>Captain Quincy".miniMessage(),
			)
			.addEnmityMessages(
		...
		private val pirateNames = listOf(
			...
			"Jonio Reson",
			"Billie Colley",
			"Jesse Hayeson",package net.horizonsend.ion.server.features.ai.faction
	...
	companion object {
		...
		val MINING_GUILD = builder("MINING_GUILD", MINING_CORP_LIGHT_ORANGE.value())
			...
			.addFleeMessages(
				...
				"Engine patched, reengaging!" to false,
				"Shields better work this time." to false,
				"You should leave before we sink you." to false,
			)
			.addEnmityMessages(
				"notice" to (0.1 to "<gray>Unregistered vessel detected near Guild claim."),
				"warn" to (0.5 to "<#FFA500>Warning: You are trespassing on Mining Guild property.")
		...
		val PERSEUS_EXPLORERS = builder("PERSEUS_EXPLORERS", EXPLORER_LIGHT_CYAN.value())
			...
			.addFriendlyFireMessages(
				"suspect" to "<gray>You doing good?",
				"warn" to "<#FFA500>Hey, stop that",
				"betrayal" to "<red>Damnit! I knew I shouldn't have trusted you."
			)
			.addSmackMessages(
				"<white>Please no! I've done nothing wrong!",
				"<white>Spare me; this ship is all I have!",
		...
		val TSAII_RAIDERS = builder("TSAII_RAIDERS", TSAII_MEDIUM_ORANGE.value())
			...
			.addSmackMessages(
				...
				"When I'm done with you, I'll mantle your skull!",
				"Your next of kin will get your remains in an urn!",
				"Will you make it even another minute?",
				"Try harder!",
				"You thought I was easy?",
				"Nice rust bucket you got there!",
				"Is that a ship or scrap metal?",
				"Your ship might not be worth even putting in a scrapyard!",
				"Get some!"
			)
			.addFleeMessages(
				"<#FFA500> Is this guy made of sriracha? Too spicy!" to true,
				"<#FFA500> Hot! Hot! Hot!" to true,
				"<#FFA500> Spicy!" to true,
				"<#FFA500> You haven't seen the last of me!" to true,
				"<#FFA500> Someone is fiesty today." to true,
				"<#FFA500> Time for a real beatdown!" to false,
				"<#FFA500> You're mine this time!" to false,
			...
			.addAggroMessage("aggro" to "<red>You're my next meal!")
			.addFriendlyFireMessages(
				"laugh" to "<gray>If you leave me alone, I'll consider not pulverizing your poor excuse of a ship.",
				"growl" to "<#FFA500>Hey! I told you to move your rust bucket elsewhere!",
				"rage" to "<red>You're my next meal!"
			)
			.addDifficultySuffix(0, "✦")
			.addDifficultySuffix(1, "✦✦")
			.addDifficultySuffix(2, "🐷")
		...
		val PIRATES = builder("PIRATES", PIRATE_SATURATED_RED.value())
			...
			.addSmackMessages(
				"Nice ship you got there. I think ill take it for myself!",
				"I'll plunder your booty!",
				"Scram, or I'll blow you to pieces! Actually, do it anyways.",
				"Someone got a bit too curious for their own good.",
		...
		val PIRATES = builder("PIRATES", PIRATE_SATURATED_RED.value())
			...
			.addFleeMessages(
				"<#FFA500> Screw this, this isn't worth my hide!" to true,
				"<#FFA500> I'm out!" to true,
				"<#FFA500> Time for a tactical retreat." to true,
				"<#FFA500> I'll be back to get you!" to true,
				"<#FFA500> You just bought yourself a death warrant!" to false,
				"<#FFA500> A closed casket funeral it is, then!" to false,
